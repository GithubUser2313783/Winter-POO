...
public class Groupes {
    ...
    public void retirerValeurPossibles(int val){
        for(int i = 0; i < 9 ; i++){
    ...
    public static void main(String[] args) {
        ...
        groupe.retirerValeurPossibles(5);
        ...
        groupe.retirerValeurPossibles(1);
        groupe.retirerValeurPossibles(2);
        groupe.retirerValeurPossibles(3);
        groupe.retirerValeurPossibles(4);
        groupe.retirerValeurPossibles(6);
        groupe.retirerValeurPossibles(8);


        testFindPlaceable(groupe, "Ne devrait pas placer : ");

      
        groupe.retirerValeurPossibles(9);
        testFindPlaceable(groupe, "Devrait placer à l'index 0 : ");
        groupe.afficheValeurPossibles();

       
        groupe.retirerValeurPossibles(7);
        groupe.afficheValeurPossibles();
        testFindPlaceable(groupe, "Ne devrait pas placer : ");
